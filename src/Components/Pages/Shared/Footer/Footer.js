...
const Footer = () => {
    return (
        <footer
            ...
            class="bg-lime-200 text-lime-800 lg:grid lg:grid-cols-5"
        >
            ...
            <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <nav
                                ...
                                class="mt-4 flex flex-col space-y-2 text-sm text-lime-800"
                            >
                                ...
                                <Link class="hover:opacity-75" to=""> Forums </Link>
                            </nav>
                        </div>
                ...
                <div class="mt-12 border-t border-lime-800 pt-12">
                    <div
                        class="text-sm text-lime-800 sm:flex sm:items-center sm:justify-between"
                    >
                        ...
                        <p class="mt-4 sm:mt-0">&copy; 2023 Foodaholic.</p>
                    </div>
