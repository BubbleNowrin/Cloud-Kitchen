    ...
    return (
        ...
        <tr>
            ...
            <td className='flex flex-col md:flex-row lg:flex-row'>
                ...
                <Link
                    className="inline-block rounded-full border border-black bg-black p-3 text-white hover:bg-transparent hover:text-black focus:outline-none focus:ring active:text-black"
                    to={`/update/${_id}`}
                >
