...
const CustomerReviews = ({ rev }) => {
    ...
    const { photoURL, name, review, rating } = rev;
    return (
            ...
            <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                ...
                >
                    <div>
                        ...
                        >
                            <p class="text-lg font-bold text-lime-700">{name}</p>
                            <p class="mt-1 text-xs font-medium text-lime-500">
                                {rating}
                            </p>
                            <p class="mt-4 text-sm text-lime-600">
                                {review}
                            </p>
